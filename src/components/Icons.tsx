...
export const SearchIcon: React.FC<React.HTMLAttributes<HTMLOrSVGElement>> = ({ className, ...props }) => {
    return (
        <svg
            fill="none"
            stroke="currentColor"
...
export const Spinner: React.FC = () => (
    <div className='inline-flex items-center mx-4 my-1' role="status">
...
export const SkeletonText: React.FC<{ size?: 'sm' | 'md' | 'lg' }> = ({ size = 'md' }) => (
    <div
...
export const GithubIcon: React.FC<React.HTMLAttributes<HTMLOrSVGElement>> = ({ className, ...props }) => {
    return (
        <svg
            fill="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
            viewBox="0 0 20 20"
            className={cx("w-5 h-5 justify-items-center", className)}
            {...props}
        >
